...
OUT=Path(os.environ.get("SECTORAL_POSITIONS_ESA_F1_SEMANTICS_OUT","sectoral_positions_esa_f1_semantics_artifacts"))
OUT.mkdir(parents=True,exist_ok=True)
API="https://data-api.ecb.europa.eu/service/data/QSA/"
USER_AGENT="romanian-monetary-dynamics/0.1.0 (+GitHub exploratory ESA F1 semantics diagnostic)"
...
def load_contract()->dict:
    return json.loads((ROOT/"model/dynamics/sectoral_financial_positions_esa_f1_semantics_diagnostic_contract_executed_2026-09-19.json").read_text(encoding="utf-8"))
...
def main():
    ...
    report={
        "audit_version":"0.1",
        "phase":"Exploratory post-run ESA F1/QSA semantics diagnostic",
        "contract":"model/dynamics/sectoral_financial_positions_esa_f1_semantics_diagnostic_contract_executed_2026-09-19.json",
