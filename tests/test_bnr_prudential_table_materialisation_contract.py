...
class BNRPrudentialTableMaterialisationContractTests(unittest.TestCase):
    ...
    def test_target_window_and_variables_are_frozen_before_values(self):
        ...
        self.assertEqual(w["start_period"],"2015-Q4")
        self.assertEqual(w["end_period"],"2025-Q4")
        self.assertEqual(w["expected_quarter_count"],41)
        ...
        self.assertIn("december 2015",w["common_window_basis"].lower())
        self.assertFalse(w["pre_common_capital_only_window"]["promotion_to_matched_panel_allowed"])
    ...
    def test_source_selection_cannot_use_numerical_fit(self):
        ...
        self.assertEqual(r["minimum_required_quarter_coverage"],41)
    ...
    def test_materialisation_does_not_open_model_cycle(self):
        ...
        self.assertTrue(self.c["semantic_validation_gate"]["no_pre_december_2015_eba_npl_backcast"])
        self.assertTrue(self.c["hard_rules"]["no_pre_december_2015_eba_npl_backcast"])
